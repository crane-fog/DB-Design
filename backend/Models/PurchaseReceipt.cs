...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class PurchaseReceipt : IEquatable<PurchaseReceipt>
    {
        /// <summary>
        /// Gets or Sets ReceiveId
        /// </summary>
        [Required]
        [DataMember(Name="receive_id", EmitDefaultValue=true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ReceiveId: ").Append(ReceiveId).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((PurchaseReceipt)obj);
        }

        /// <summary>
        /// Returns true if PurchaseReceipt instances are equal
        /// </summary>
        /// <param name="other">Instance of PurchaseReceipt to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PurchaseReceipt other)
        {
            ...
            return 
                (
                    ...
                    ReceiveId.Equals(other.ReceiveId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + ReceiveId.GetHashCode();
        ...
        public static bool operator ==(PurchaseReceipt left, PurchaseReceipt right)
        {
